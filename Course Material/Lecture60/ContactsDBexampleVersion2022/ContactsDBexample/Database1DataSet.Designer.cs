...
namespace ContactsDBexample {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ContactsDataTable : global::System.Data.TypedTableBase<ContactsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ContactsRow AddContactsRow(string Name, string Company, string Telephone) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ContactsRow FindByCustomerId(int CustomerId) {
...
namespace ContactsDBexample.Database1DataSetTableAdapters {
    ...
    public partial class ContactsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Contacts] WHERE (([CustomerId] = @Original_CustomerId) AND ([Name] = @Original_Name) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)) AND ((@IsNull_Telephone = 1 AND [Telephone] IS NULL) OR ([Telephone] = @Original_Telephone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Contacts] ([Name], [Company], [Telephone]) VALUES (@Name, @Com" +
                "pany, @Telephone);\r\nSELECT CustomerId, Name, Company, Telephone FROM Contacts WH" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Contacts] SET [Name] = @Name, [Company] = @Company, [Telephone] = @Telephone WHERE (([CustomerId] = @Original_CustomerId) AND ([Name] = @Original_Name) AND ((@IsNull_Company = 1 AND [Company] IS NULL) OR ([Company] = @Original_Company)) AND ((@IsNull_Telephone = 1 AND [Telephone] IS NULL) OR ([Telephone] = @Original_Telephone)));
SELECT CustomerId, Name, Company, Telephone FROM Contacts WHERE (CustomerId = @CustomerId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ContactsDBexample.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerId, Name, Company, Telephone FROM dbo.Contacts";
        ...
        public virtual int Delete(int Original_CustomerId, string Original_Name, string Original_Company, string Original_Telephone) {
        ...
        public virtual int Insert(string Name, string Company, string Telephone) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Company, string Telephone, int Original_CustomerId, string Original_Name, string Original_Company, string Original_Telephone, int CustomerId) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Company, string Telephone, int Original_CustomerId, string Original_Name, string Original_Company, string Original_Telephone) {
            return this.Update(Name, Company, Telephone, Original_CustomerId, Original_Name, Original_Company, Original_Telephone, Original_CustomerId);
        }
    }
